...
### 🛠数据摘要相关方法:
    ...
    crypto.digest (数据: String|ArrayBuffer, 算法='md5|md2|sha1|sha256|sha384|sha512|crc32|crc16|adler32'): String
...
### Bitmap相关方法, 注意: 大写的Bitmap是类名, 小写是对象;
    ...
    bitmap.drawBitmap(bmp, x, y); // 将指定Bitmap绘制到本Bitmap上; 
    // drawBitmap 详解;
    ...
    var s1 = Bitmap.copyRect(src, 0, 0, 200, 200);
    b1.drawBitmap (s1, 0, 0);
